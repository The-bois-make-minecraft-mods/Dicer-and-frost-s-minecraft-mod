...
public class ShadowlogsBlock extends FrostAndDicersVanillaenhancedModElements.ModElement {
	@ObjectHolder("frost_and_dicers_vanillaenhanced:shadowlogs")
	public static final Block block = null;
	public ShadowlogsBlock(FrostAndDicersVanillaenhancedModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.6500000000000001f, 10f).lightValue(0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("shadowlogs");
		}
