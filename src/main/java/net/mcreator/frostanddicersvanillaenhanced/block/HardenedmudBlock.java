...
public class HardenedmudBlock extends FrostAndDicersVanillaenhancedModElements.ModElement {
	@ObjectHolder("frost_and_dicers_vanillaenhanced:hardenedmud")
	public static final Block block = null;
	public HardenedmudBlock(FrostAndDicersVanillaenhancedModElements instance) {
		super(instance, 31);
	}
