...
public class ShadowsharditemItem extends FrostAndDicersVanillaenhancedModElements.ModElement {
	@ObjectHolder("frost_and_dicers_vanillaenhanced:shadowsharditem")
	public static final Item block = null;
	public ShadowsharditemItem(FrostAndDicersVanillaenhancedModElements instance) {
		super(instance, 74);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("shadowsharditem");
		}
